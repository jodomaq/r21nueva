...
export const useDashboardData = (enabled = true) => {
  const queryResults = useQueries({
    queries: [
      ...
      { queryKey: ['administrative-tree-full'], queryFn: fetchAdministrativeTreeFull, staleTime: 1000 * 300, enabled },
  ...
  const data = {
    ...
    fullAdministrativeTree: fullTreeQuery.data ?? [],
